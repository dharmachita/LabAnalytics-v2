...
<body translate="no">
<p class="center">Space Invadors destruyeron esta página! Toma revancha Luke!!
<br /> Usa <span class="label label-danger">espacio</span> para disparar y <span class="label label-danger">←</span>&#160;<span class="label label-danger">→</span> para mover!&#160;&#160;&#160;<button class="btn btn-default btn-xs" id="restart">Restart</button></p>
...
;(function () {
  ...
  Game.prototype = {
    ...
    draw: function () {
      ...
      if (this.lost) {
        ...
        screen.fillText("Perdiste", gameSize.width / 2, gameSize.height / 2);
        screen.font = "20px Lucida Console";
        screen.fillText("Puntos: " + kills, gameSize.width / 2, gameSize.height / 2 + 30);
        ...
        screen.fillText("Puntos: " + kills, gameSize.width, gameSize.height - 12);
      }
  ...
  Player.prototype = {
    update: function () {
      ...
      if (this.keyboarder.isDown(this.keyboarder.KEYS.LEFT) && this.coordinates.x > 0) this.coordinates.x -= 2;else
      if (this.keyboarder.isDown(this.keyboarder.KEYS.RIGHT) && this.coordinates.x < gameSize.width - this.size.width) this.coordinates.x += 2;
